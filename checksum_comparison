...
def checklist_compare (checklist_path_A, checklist_path_B):
    print("Sammenlikner sjekksumliste/mengde A - " + checklist_path_A[-11:] + " og sjekksumliste/mengde B - " + checklist_path_B[-11:])
    file_list_A = []
    file_list_B = []
    checksum_list_A = []
    checksum_list_B = []
    ...
    read_file.close()
    print("Lengde på filliste for menge A: " + str(len(file_list_A)))

    for sjekksum in file_list_A:
        checksum_list_A += [sjekksum[1]]
    print("Lengde på sjekksumliste for menge A: " + str(len(file_list_A)))
    ...
    print("Lengde på filliste for mengde B: " +  str(len(file_list_B)))


    for sjekksum in file_list_B:
        checksum_list_B += [sjekksum[1]]

    print("Lengde på sjekksumliste for mengde B: " + str(len(file_list_B)))
    ...
    print("Så mange finnes i mengde A, som ikke finnes i mengde B: " + str(len(set_diff_list_AB)))
    print("Så mange finnes i mengde B, som ikke finnes i mengde A: " + str(len(set_diff_list_BA)))
    print("Så mange finnes i mengde A, som også finnes i mengde B: " + str(len(set_intersect)))
    print("Så mange finnes i kun én av mengdene: " + str(len(set_sym_diff)))
